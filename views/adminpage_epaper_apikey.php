...
<div class='tg_info_box tg_box'>
    <div class='tg_info_box_inner'>
        ...
        <div class='tg_info_box_inner_content'>
            <?php if(OPENSSL_VERSION_NUMBER > 0x012080bf)  : ?>
                <a class="button" href="<?php echo $this->oView->registerUrl ?>">Request new ApiKey</a>
            <?php else: ?>
                <?php _e('Please Update OpenSSL.' ,"1000grad-epaper"); ?>
            <?php endif;?>
        </div>
    </div>
</div>
...
<?php /*<div class='tg_info_box tg_box'>
    <div class='tg_info_box_inner'>
        <div class="tg_info_box_inner_header"><?php _e("Request WP-Key","1000grad-epaper") ?></div>
        <div class='tg_info_box_inner_content'>
