<p>
    ...
    <div>
        <input id="<?php echo $this->oView->widget->get_field_id( 'title' ); ?>" name="<?php echo $this->oView->widget->get_field_name( 'title' ); ?>" value="<?php echo (isset($this->oView->widget_instance['title'])) ? $this->oView->widget_instance['title'] : ""; ?>" style="width:100%;" />
    </div>
</p>
