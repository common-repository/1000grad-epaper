...
?>
    ...
    <div class='tg_info_box tg_box'>
        <div class='tg_info_box_inner'>
            <div class="tg_info_box_inner_header"><?php _e("Latest news", '1000grad-epaper'); ?></div>
            <div class='tg_info_box_inner_content'>
                <?php if(empty($this->oView->aRssContent)) _e("Currently there are no news available.", '1000grad-epaper') ?>
                <?php foreach($this->oView->aRssContent as $aEntry){ ?>
                    <div>
                        <h3>
                            <a href="<?php echo $aEntry['link'] ?>" target="_blank" ><?php echo $aEntry['title'] ?></a>
                        </h3>
                        <small><em>Posted on <?php echo $aEntry['date'] ?></em></small>
                    ...
                    <div class="tg_box_channel_list_content_details">
                        ...
                        <div class="tg-border-radius tg_channel_editbox">
                            ...
                            <div class="tg_channel_config">
                                ...
                                <?php if($this->oView->sAppUrl && !empty($this->oView->sAppUrl)): ?>
                                        <div class="tg_channelbox_embed_headline"><?php _e("Manage your edelpaper:", '1000grad-epaper'); ?></div>
                                        <ul>
                                            <li> via <a href="<?php echo $this->oView->sAppUrl ?>" target="_blank">Edelpaper-CMS</a></li>
                                        </ul>
                                <?php endif; ?>
                                ...
                                <div class="uploadify_button_container float_left">
                                    <form class="epaper_upload_form" enctype="multipart/form-data">
                                        <div class="upload_select_files button_blue">
                                            <span><?php _e('upload pdf', '1000grad-epaper') ?></span>
                                            <input id="file_upload_<?php echo ($iChannel + 1) ?>" channel="<?php echo ($iChannel + 1) ?>" type="file" name="file" class="file_upload"/>
                                        </div>
                                        <input type="button" value="upload" class="button_blue hidden"/>
                                ...
                                <?php if ($bEpaperExists): ?>
                                    <div class="tg_clear_channel float_left button_blue">
                                        <span channel="<?php echo $oChannelInfo->id ?>"><?php _e('clear permalink', '1000grad-epaper') ?></span>
                                    </div>
    ...
    <?php endforeach ?>
        ...
        <div class='tg_info_box tg_box'>
            <div class='tg_info_box_inner'>
                ...
                <div class='tg_info_box_inner_content'>
                    <div>
    <?php _e("You can get more edelpaper channels via PayPal or Credit Card.", "1000grad-epaper") ?>
