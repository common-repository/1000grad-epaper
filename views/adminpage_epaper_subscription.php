...
?><div class="text-justify tg_text_box">
    <?php _e("You can manage your plan below, as often as you need. The payment is realized with monthly Subscription.<br> 
...
<?php if(!$this->oView->isUpdatedAccountmanager): ?>
    ...
    <div class='tg_info_box_inner'>
        ...
        <div class='tg_info_box_inner_content'>
            ...
            <div class="misc-pub-section">
                ...
                <?php if($this->oView->isUpdatedAccountmanager && isset($this->oView->manageAccountUrl)){ ?>
                    <a class="button_blue" href="<?php echo $this->oView->manageAccountUrl ?>">Manage Subscription</a>
                <?php } ?>
...
<div class='tg_info_box tg_box'>
    <div class='tg_info_box_inner'>
        <div class="tg_info_box_inner_header"><?php _e("Accountmanager info", '1000grad-epaper'); ?></div>
        <div class='tg_info_box_inner_content'>
            <?php echo $this->oView->isUpdatedAccountmanager?'Version 2.0':'Version 1.0'; ?>
        </div>
    </div>  
</div>